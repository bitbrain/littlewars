package de.myreality.dev.littlewars.examples.light;
...
public class LightTest extends BasicGame {
	...
	public void init(GameContainer container) throws SlickException {
		tiles = new SpriteSheet("res/examples/wizardGame/grass.png", 4, 4);
		generateMap();
	}
	...
	private void generateMap() {
		...
		lights.add(new Light(2,2,4f,Color.red));
		lights.add(new Light(2,11,4f,Color.cyan));
